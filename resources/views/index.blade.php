...
<link rel="stylesheet" href="{{ asset('css/style.css') }}">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
          	<h1 class="mb-4">Saving one animal won't change the world, but for that one animal, the world will change forever </h1>
            ...
            <div class="col-md-7 pl-md-5 py-md-5">
                ...
                <div class="row">
                    <div class="col-md-6 services-2 w-100 d-flex">
                        ...
                        <div class="text pl-3">
                            <h4>Rescue a Life</h4>
                            <p>Adopt a pet and give a deserving animal a loving forever home.</p>
                        </div>
                    </div>
                    <div class="col-md-6 services-2 w-100 d-flex">
                        ...
                        <div class="text pl-3">
                            ...
                            <p>Get guidance and resources to help your new pet thrive.</p>
                        </div>
                    </div>
                    <div class="col-md-6 services-2 w-100 d-flex">
                        ...
                        <div class="text pl-3">
                            ...
                            <p>Join a community dedicated to saving and caring for pets.</p>
                        </div>
                    </div>
                    <div class="col-md-6 services-2 w-100 d-flex">
                        <div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-veterinarian"></span></div>
                        <div class="text pl-3">
                            <h4>Adoption Assistance</h4>
                            <p>Receive support to ensure a smooth transition for you and your pet.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <h2>Join Our Pet Adoption Community</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 ftco-animate">
                <div class="block-7">
                    <div class="img" style="background-image: url(images/pic_1.jpg);"></div>
                    <div class="text-center p-4">
                        <span class="excerpt d-block">Adopt a Pet</span>
                        <p class="mb-4">Give a loving home to a pet in need and find a loyal companion.</p>
                        <ul class="pricing-text mb-5">
                            <li><span class="fa fa-check mr-2"></span>Lifetime Friend</li>
                            <li><span class="fa fa-check mr-2"></span>Health Check</li>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="block-7">
                    <div class="img" style="background-image: url(images/pic_2.jpg);"></div>
                    <div class="text-center p-4">
                        <span class="excerpt d-block">Shelter a Pet</span>
                        <p class="mb-4">Foster a pet temporarily and help them find their forever home.</p>
                        <ul class="pricing-text mb-5">
                            <li><span class="fa fa-check mr-2"></span>Flexible Foster</li>
                            <li><span class="fa fa-check mr-2"></span>Supplies Included</li>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="block-7">
                    <div class="img" style="background-image: url(images/pic-3.jpg);"></div>
                    <div class="text-center p-4">
                        <span class="excerpt d-block">Volunteer with Us</span>
                        <p class="mb-4">Help pets by volunteering at events or with daily care tasks.</p>
                        <ul class="pricing-text mb-5">
                            <li><span class="fa fa-check mr-2"></span>Flexible Hours</li>
                            <li><span class="fa fa-check mr-2"></span>Make a Difference</li>
                            <li><span class="fa fa-check mr-2"></span>Training Offered</li>
                            <li><span class="fa fa-check mr-2"></span>Community Fun</li>
                        </ul>
                        <a href="#" class="btn btn-primary d-block px-2 py-3">Apply to Volunteer</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer">
            ...
            <div class="block-21 mb-4 d-flex">
              ...
              <li><a href="#" class="py-2 d-block">Adopt</a></li>
